...
3) Steam API Key if you want to use it to get other Steam_Settings related things and just use SteamAPI for downloads. (Currently Only in source. Not in a full release build.)
